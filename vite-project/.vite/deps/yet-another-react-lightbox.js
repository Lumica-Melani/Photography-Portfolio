...
import {
  require_react_dom
} from "./chunk-YTOT4KTD.js";
import {
  __toESM,
  require_react
} from "./chunk-KQTB2XQD.js";
...
function Portal({ children, animation, styles, className, on, portal, close, labels }) {
  ...
  return mounted ? (0, import_react_dom.createPortal)(React.createElement(LightboxRoot, { ref: handleRef, className: clsx(className, cssClass(cssPrefix$1()), cssClass(CLASS_NO_SCROLL_PADDING), visible && cssClass(cssPrefix$1("open"))), "aria-modal": true, role: "dialog", "aria-label": translateLabel(labels, "Lightbox"), style: {
